...
cfg = os.path.join(parent, "models/segment/gelan-c-seg.yaml")
model = Model(cfg, ch=3, nc=80, anchors=3)
# model = model.half()
model = model.to(device)
_ = model.eval()
# ckpt = torch.load('./yolov9-c.pt', map_location='cpu')
ckpt = torch.load('/home/vladimir/Code/yolov9/runs/train-seg/gelan-c-seg-20240403201942-ft/weights/best.pt', map_location='cpu')
...
torch.save(m_ckpt, "/home/vladimir/Code/yolov9/runs/train-seg/gelan-c-seg-20240403201942-ft/weights/best-converted.pt")
